...
describe('render()', function () {
  var sandbox, expectation, spy, render,
    obj = {text: 'foo'};

  beforeEach(function () {
    sandbox = sinon.sandbox.create();
    spy = sinon.spy(function () { return 'html'; });
    expectation = sinon.expectation.create('deasync').returns(spy);
    render = proxyquire('./render', { 'deasync': expectation });
  });
